...
export default function Location() {
  ...
  return (
    <div className="">
      <h2 className="text-4xl text-bright-pink font-semibold p-4 mb-12">Sneak peak at the best UK runnning locations</h2>
      <div className="md:grid grid-cols-3 grid-rows-3 gap-4">
        ...
        <div className="bg-white row-span-3 row-start-2 md:border-olivine relative">
        ...
        <div className="bg-white row-span-2 col-start-2 row-start-3 md:border-olivine place-content-center items-center p-4"><span className="font-semibold">Location:</span> North Wales, Eryri National Park</div>
        <div className="bg-white row-span-2 col-start-3 row-start-3 md:border-olivine place-content-center items-center p-4"><span className="font-semibold">Weather:</span> rainy, foggy, ugly</div>
      </div>
    </div>
  )
}
